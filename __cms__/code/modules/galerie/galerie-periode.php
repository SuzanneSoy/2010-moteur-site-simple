...
class GaleriePériode {
	...
	public static function vue($chemin, $vue = "normal") {
		if ($vue == "normal") {
			...
			$ret .= '<div class="galerie photos periode">';
			$ret .= '<ul>';
			...
			if (Permissions::vérifier_permission($chemin, "nouvelle_page", Authentification::get_utilisateur())) {
				...
				$ret .= '<img alt="nouvel évènement" src="' . $chemin->get_url("?vue=image_nouvel_evenement") . '" />';
				$ret .= '</div>';
				$ret .= '<div class="titre">';
				...
				$ret .= '<input type="submit" value="Nouvel évènement"/>';
				$ret .= '</p>';
				$ret .= '</form>';
